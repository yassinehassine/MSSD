...
-- Insert test admin user (password: admin123 - hashed with BCrypt)
INSERT INTO users (username, email, password, role, created_at) 
VALUES ('admin', 'admin@mssd.com', '$2a$10$XptfskJDGleLq2UfL.H45e5wI0gJFLJ6VhSz/T8HlZP/2h9e9a2hS', 'ADMIN', NOW())
ON DUPLICATE KEY UPDATE username = username;

-- Insert test regular user (password: user123 - hashed with BCrypt)
INSERT INTO users (username, email, password, role, created_at) 
VALUES ('user', 'user@mssd.com', '$2a$10$8qVVL8qQxvvNkQnO/x6Z.u8WwCmU5jN0wvYZKL5hYZNQ9dX1J4ksO', 'USER', NOW())
ON DUPLICATE KEY UPDATE username = username;
